...
sink("Results_Scenario2_5p.txt")

names_results1 <- c("Estimates_Scenario2_n40", "Estimates_Scenario2_n80", "Estimates_Scenario2_n160", "Estimates_Scenario2_n320")
names_results2 <- c("SE_Estimates_Scenario2_n40", "SE_Estimates_Scenario2_n80", "SE_Estimates_Scenario2_n160", "SE_Estimates_Scenario2_n320")
names_results3 <- c("Qoptimal_Scenario2_n40", "Qoptimal_Scenario2_n80", "Qoptimal_Scenario2_n160", "Qoptimal_Scenario2_n320")
...
if(perc == 0.25 || perc == 0.5 || perc == 0.75 || perc ==1) cat("Perc. Replic. MC =",perc*100,"%","\n")
 ...
 PC1 <- 0.025*N #percentage 1 of contamination
 PC2 <- 0.025*N #percentage 2 of contamination
