...
boxplot(MLE_beta1_n80,MLE_beta1_n160,MLE_beta1_n320,
MLEC_beta1_n80,MLEC_beta1_n160,MLEC_beta1_n320,
main=expression( paste("MLE for ", beta[1])),
xlab="Sample size",ylab="",names=c(80,160,320,80,160,320),outline=T,
ylim=c(0.0,1.2), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(0.8,0,col=2,lty=2,lwd=2)
abline(v=3.5,lty=3,lwd=2)
legend(0.0, 0.1,"Absence of contamination",bty="n",cex=1.3)
legend(3.2, 0.1,"Presence of contamination",bty="n",cex=1.3)

#********************MLE estimates of beta2****************#
boxplot(MLE_beta2_n80,MLE_beta2_n160,MLE_beta2_n320,
MLEC_beta2_n80,MLEC_beta2_n160,MLEC_beta2_n320,
main=expression( paste("MLE for ", beta[2])),
xlab="Sample size",ylab="",names=c(80,160,320,80,160,320),outline=T,
ylim=c(-1.7,-0.4), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(-1.2,0,col=2,lty=2,lwd=2)
abline(v=3.5,lty=3,lwd=2)
legend(0.0,-1.6,"Absence of contamination",bty="n",cex=1.3)
legend(3.2,-1.6,"Presence of contamination",bty="n",cex=1.3)

#********************MLE estimates of beta3****************#
boxplot(MLE_beta3_n80,MLE_beta3_n160,MLE_beta3_n320,
MLEC_beta3_n80,MLEC_beta3_n160,MLEC_beta3_n320,
main=expression( paste("MLE for ", beta[3])),
xlab="Sample size",ylab="",names=c(80,160,320,80,160,320),outline=T,
ylim=c(-1.7,-0.5), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(-1.2,0,col=2,lty=2,lwd=2)
abline(v=3.5,lty=3,lwd=2)
legend(0.0,-1.6,"Absence of contamination",bty="n",cex=1.3)
legend(3.2,-1.6,"Presence of contamination",bty="n",cex=1.3)
...
boxplot(MLE_gama1_n80,MLE_gama1_n160,MLE_gama1_n320,
MLEC_gama1_n80,MLEC_gama1_n160,MLEC_gama1_n320,
main=expression( paste("MLE for ", gamma[1])),
xlab="Sample size",ylab="",names=c(80,160,320,80,160,320),outline=T,
ylim=c(-1.0,6.5), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(3.8,0,col=2,lty=2,lwd=2)
abline(v=3.5,lty=3,lwd=2)
legend(0.0,-0.4,"Absence of contamination",bty="n",cex=1.3)
legend(3.2,-0.4,"Presence of contamination",bty="n",cex=1.3)

#********************MLE estimates of gamma2****************#
boxplot(MLE_gama2_n80,MLE_gama2_n160,MLE_gama2_n320,
MLEC_gama2_n80,MLEC_gama2_n160,MLEC_gama2_n320,
main=expression( paste("MLE for ", gamma[2])),
xlab="Sample size",ylab="",names=c(80,160,320,80,160,320),outline=T,
ylim=c(-4.5,4), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(0.7,0,col=2,lty=2,lwd=2)
abline(v=3.5,lty=3,lwd=2)
legend(0.0,-3.8,"Absence of contamination",bty="n",cex=1.3)
legend(3.2,-3.8,"Presence of contamination",bty="n",cex=1.3)

#********************MLE estimates of gamma3****************#
boxplot(MLE_gama3_n80,MLE_gama3_n160,MLE_gama3_n320,
MLEC_gama3_n80,MLEC_gama3_n160,MLEC_gama3_n320,
main=expression( paste("MLE for ", gamma[3])),
xlab="Sample size",ylab="",names=c(80,160,320,80,160,320),outline=T,
ylim=c(-4,5.5), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(0.7,0,col=2,lty=2,lwd=2)
abline(v=3.5,lty=3,lwd=2)
legend(0.0,-3.2,"Absence of contamination",bty="n",cex=1.3)
legend(3.2,-3.2,"Presence of contamination",bty="n",cex=1.3)

#**************************SMLE estimates******************************#

#********************SMLE estimates of beta1****************#
boxplot(SMLE_beta1_n80,SMLE_beta1_n160,SMLE_beta1_n320,
SMLEC_beta1_n80,SMLEC_beta1_n160,SMLEC_beta1_n320,
...
boxplot(SMLE_beta2_n80,SMLE_beta2_n160,SMLE_beta2_n320,
SMLEC_beta2_n80,SMLEC_beta2_n160,SMLEC_beta2_n320,
...
boxplot(SMLE_beta3_n80,SMLE_beta3_n160,SMLE_beta3_n320,
SMLEC_beta3_n80,SMLEC_beta3_n160,SMLEC_beta3_n320,
...
boxplot(SMLE_gama1_n80,SMLE_gama1_n160,SMLE_gama1_n320,
SMLEC_gama1_n80,SMLEC_gama1_n160,SMLEC_gama1_n320,
...
boxplot(SMLE_gama2_n80,SMLE_gama2_n160,SMLE_gama2_n320,
SMLEC_gama2_n80,SMLEC_gama2_n160,SMLEC_gama2_n320,
...
boxplot(SMLE_gama3_n80,SMLE_gama3_n160,SMLE_gama3_n320,
SMLEC_gama3_n80,SMLEC_gama3_n160,SMLEC_gama3_n320,
...
boxplot(MDPDE_beta1_n80,MDPDE_beta1_n160,MDPDE_beta1_n320,
MDPDEC_beta1_n80,MDPDEC_beta1_n160,MDPDEC_beta1_n320,
...
boxplot(MDPDE_beta2_n80,MDPDE_beta2_n160,MDPDE_beta2_n320,
MDPDEC_beta2_n80,MDPDEC_beta2_n160,MDPDEC_beta2_n320,
...
boxplot(MDPDE_beta3_n80,MDPDE_beta3_n160,MDPDE_beta3_n320,
MDPDEC_beta3_n80,MDPDEC_beta3_n160,MDPDEC_beta3_n320,
...
boxplot(MDPDE_gama1_n80,MDPDE_gama1_n160,MDPDE_gama1_n320,
MDPDEC_gama1_n80,MDPDEC_gama1_n160,MDPDEC_gama1_n320,
...
boxplot(MDPDE_gama2_n80,MDPDE_gama2_n160,MDPDE_gama2_n320,
MDPDEC_gama2_n80,MDPDEC_gama2_n160,MDPDEC_gama2_n320,
...
boxplot(MDPDE_gama3_n80,MDPDE_gama3_n160,MDPDE_gama3_n320,
MDPDEC_gama3_n80,MDPDEC_gama3_n160,MDPDEC_gama3_n320,
