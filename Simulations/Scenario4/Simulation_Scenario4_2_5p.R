...
sink("Results_Scenario4_2_5p.txt")
...
VBETA <- c(-2.5, -2.5) #true beta values
VGAMA <- c(4.5, 1.4) #true gama values
...
Z <- matrix(c(rep(1,VN[1]), z1), ncol=2, byrow=F); #regressor matrix for the precision submodel
...
cat(" TRUE VALUES ","\n")
cat(" Sample size ",N ,"\n")
out_VTHETA <- rbind(VTHETA);colnames(out_VTHETA)=c("beta1", "beta2", "gama1", "gama2");rownames(out_VTHETA)=c("");print(out_VTHETA)
...
output_mle = rbind(out_estimates_MLE);colnames(output_mle)=c("Mean estimates","Bias","Mean SE", "Null level", "Median estimates","Median Bias","Median SE");rownames(output_mle)=c("beta1","beta2","gama1","gama2");print(output_mle)
cat(" ================================ MLE estimates with contamination ================================ \n")
output_mle_c = rbind(out_estimates_MLE_C);colnames(output_mle_c)=c("Estimates","Bias","SE", "Null level", "Median estimates","Median Bias","Median SE");rownames(output_mle_c)=c("beta1","beta2","gama1","gama2");print(output_mle_c)
cat(" ================================ SMLE estimates without contamination ================================\n")
cat(" Mean of q-optimal is ",QOPTIMAL_SMLE ,"\n")
output_smle = rbind(out_estimates_SMLE);colnames(output_smle)=c("Estimates","Bias","SE", "Null level", "Median estimates","Median Bias","Median SE");rownames(output_smle)=c("beta1","beta2","gama1","gama2");print(output_smle)
cat(" ================================ SMLE estimates with contamination ================================ \n")
cat(" Mean of q-optimal is ",QOPTIMAL_SMLE_C ,"\n")
output_smle_c = rbind(out_estimates_SMLE_C);colnames(output_smle_c)=c("Estimates","Bias","SE", "Null level", "Median estimates","Median Bias","Median SE");rownames(output_smle_c)=c("beta1","beta2","gama1","gama2");print(output_smle_c)
cat(" ================================ MDPDE estimates without contamination ================================ \n")
cat(" Mean of q-optimal is ",QOPTIMAL_MDPDE ,"\n")
output_mdpde = rbind(out_estimates_MDPDE);colnames(output_mdpde)=c("Estimates","Bias","SE", "Null level", "Median estimates","Median Bias","Median SE");rownames(output_mdpde)=c("beta1","beta2","gama1","gama2");print(output_mdpde)
cat(" ================================ MDPDE estimates with contamination ================================ \n")
cat(" Mean of q-optimal is ",QOPTIMAL_MDPDE_C ,"\n")
output_mdpde_c = rbind(out_estimates_MDPDE_C);colnames(output_mdpde_c)=c("Estimates","Bias","SE", "Null level", "Median estimates","Median Bias","Median SE");rownames(output_mdpde_c)=c("beta1","beta2","gama1","gama2");print(output_mdpde_c)
cat(" ================================ Ratio of MSE ================================ \n")
...
col.names = c("MLE_beta1", "MLE_beta2", "MLE_gama1", "MLE_gama2", "MLE_C_beta1", "MLE_C_beta2", "MLE_C_gama1", "MLE_C_gama2",
"SMLE_beta1", "SMLE_beta2", "SMLE_gama1", "SMLE_gama2", "SMLE_C_beta1", "SMLE_C_beta2", "SMLE_C_gama1", "SMLE_C_gama2",
"MDPDE_beta1", "MDPDE_beta2", "MDPDE_gama1", "MDPDE_gama2", "MDPDE_C_beta1", "MDPDE_C_beta2", "MDPDE_C_gama1", "MDPDE_C_gama2"))
...
col.names = c("se_MLE_beta1", "se_MLE_beta2", "se_MLE_gama1", "se_MLE_gama2", "se_MLE_C_beta1", "se_MLE_C_beta2", "se_MLE_C_gama1", "se_MLE_C_gama2",
"se_MLE_beta1","se_SMLE_beta2", "se_SMLE_gama1", "se_SMLE_gama2", "se_SMLE_C_beta1", "se_SMLE_C_beta2", "se_SMLE_C_gama1", "se_SMLE_C_gama2",
"se_MDPDE_beta1", "se_MDPDE_beta2", "se_MDPDE_gama1", "se_MDPDE_gama2", "se_MDPDE_C_beta1", "se_MDPDE_C_beta2", "se_MDPDE_C_gama1", "se_MDPDE_C_gama2"))
