...
data40 <- read.table("Estimates_Scenario4_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario4_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario4_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario4_n320.txt", h=T)
...
ylim=c(-4.2,-1.6), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(-2.5,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,-4.0,"Absence of contamination",bty="n",cex=1.3)
legend(4.2,-4.0,"Presence of contamination",bty="n",cex=1.3)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-4.6,1.8), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(-2.5,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,-4.15,"Absence of contamination",bty="n",cex=1.3)
legend(4.2,-4.15,"Presence of contamination",bty="n",cex=1.3)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(1.0,8.5), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-9.0,6.0), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(1.4,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,-8.0,"Absence of contamination",bty="n", cex=1.3)
legend(4.2,-8.0,"Presence of contamination",bty="n", cex=1.3)
