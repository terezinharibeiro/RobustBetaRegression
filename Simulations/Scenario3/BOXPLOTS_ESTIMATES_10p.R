...
ylim=c(0.0, 2.4), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(1.0,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0, 0.15,"Absence of contamination",bty="n",cex=1.3)
legend(4.2, 0.15,"Presence of contamination",bty="n",cex=1.3)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-1.6, 3.4), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
...
legend(4.2,-0.4,"Presence of contamination",bty="n",cex=1.3)
