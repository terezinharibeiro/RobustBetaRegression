...
# Reference
# Ribeiro, T. K. A.; Ferrari, S. L. P. (2022). Robust estimation in beta regression via maximum Lq-likelihood.
#***ARGUMENTS***#
# y - response variable.
# X -  regressor matrix for the mean submodel.
# Z -  regressor matrix for the precision submodel.
# qoptimal - logical; if TRUE, the tuning constant q is chosen via the data-driven algorithm proposed by Ribeiro and Ferrari (2022)
# if FALSE, a fixed 0 < q0 <= 1 is required. Defaults are TRUE and q0 = 1, respectively.
# m - number of grid spacings for the data-driven algorithm. Default is m = 3.
