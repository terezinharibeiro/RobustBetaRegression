...
data40 <- read.table("Qoptimal_Scenario3_n40.txt", h=T)
data80 <- read.table("Qoptimal_Scenario3_n80.txt", h=T)
data160 <- read.table("Qoptimal_Scenario3_n160.txt", h=T)
data320 <- read.table("Qoptimal_Scenario3_n320.txt", h=T)
