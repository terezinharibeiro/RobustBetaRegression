...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-0.2, 3.0), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(0.0, 2.8), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(1.8,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,0.25,"Absence of contamination",bty="n",cex=1.3)
legend(4.2,0.25,"Presence of contamination",bty="n",cex=1.3)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(1.9,5.8), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(4.5,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,2.2,"Absence of contamination",bty="n", cex=1.3)
legend(4.2,2.2,"Presence of contamination",bty="n", cex=1.3)
