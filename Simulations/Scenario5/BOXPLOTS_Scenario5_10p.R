...
ylim=c(-2.9,0.4), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-5.2,1.9), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(-2.5,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(0.0,8.4), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(3.8,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,0.5,"Absence of contamination",bty="n",cex=1.3)
legend(4.2,0.5,"Presence of contamination",bty="n",cex=1.3)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-8.5,6.5), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-9.0,8), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col=NULL)
abline(0.7,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
