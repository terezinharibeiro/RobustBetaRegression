...
data40 <- read.table("Estimates_Scenario1_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario1_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario1_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario1_n320.txt", h=T)
...
ylim=c(-2.4,-1.4), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(-1.8,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,-2.32,"Absence of contamination",bty="n",cex=1.3)
legend(4.2,-2.32,"Presence of contamination",bty="n",cex=1.3)
...
xlab="Sample size",ylab="",names=c(40,80,160,320,40,80,160,320),outline=T,
ylim=c(-3.5,0.2), cex=1.5,cex.lab=2.0,cex.axis=1.5,cex.main=2.0, pch=16, col = NULL)
abline(-2.0,0,col=2,lty=2,lwd=2)
abline(v=4.5,lty=3,lwd=2)
legend(0.0,-3.25,"Absence of contamination",bty="n",cex=1.3)
legend(4.2,-3.25,"Presence of contamination",bty="n",cex=1.3)
